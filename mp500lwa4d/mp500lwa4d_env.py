...
class Mp500Lwa4dEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        */scan: Laser Readings
        ...
        rospy.Subscriber("/mp500lwa4d/odom", Odometry, self._odom_callback)
    ...
    def _check_odom_ready(self):
        self.odom = None
        rospy.logdebug("Waiting for /mp500lwa4d/odom to be READY...")
        while self.odom is None and not rospy.is_shutdown():
            try:
                self.odom = rospy.wait_for_message("/mp500lwa4d/odom", Odometry, timeout=5.0)
                rospy.logdebug("Current /mp500lwa4d/odom READY=>")

            except:
                rospy.logerr("Current /mp500lwa4d/odom not ready yet, retrying for getting odom")
